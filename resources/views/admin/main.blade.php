        ...
        <div class="row">
            <div id="clientList" class="bigbox box2 col-xs-4" style="overflow-y:scroll;height:600px;">
                <div style="">
                    ...
                    <h4 class="text-center">접수인단1 <small>[결제]</small></h4>
                    {{--{{ $wave_client->links() }}--}}
                    <?php
                    ...
                    @elseif (empty($show_list_clicked))
                        <div class="col-sm-12">
                            <a class="btn btn-default" href="<?=$_REQUEST['']?>?show_list_clicked=true">
                                리스트를 보려면 클릭해주세요. (테스트중)
                            </a>
                        </div>
                    @else
